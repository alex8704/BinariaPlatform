...
- GestPymeSOC-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- GestPymeSOC-ui: main application module, development time
- GestPymeSOC-production: module that produces a production mode WAR for deployment
