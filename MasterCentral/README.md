...
- MasterCentral-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- MasterCentral-ui: main application module, development time
- MasterCentral-production: module that produces a production mode WAR for deployment
