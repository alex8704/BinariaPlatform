...
- OrionSecurity-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- OrionSecurity-ui: main application module, development time
- OrionSecurity-production: module that produces a production mode WAR for deployment
